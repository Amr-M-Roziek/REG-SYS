                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td><?php if (!empty($row['abstract_filename'])) { ?><a href="manage-users2.php?download_abstract=1&uid=<?php echo $row['id'];?>&mode=inline" class="btn btn-info btn-xs">View</a> <a href="manage-users2.php?download_abstract=1&uid=<?php echo $row['id'];?>&mode=download" class="btn btn-default btn-xs">Download</a><?php } else { echo '—'; } ?></td>
