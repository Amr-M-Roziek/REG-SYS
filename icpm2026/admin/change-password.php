...
// Ensure connection is usable; set charset if available
if (isset($con) && $con) {
  @mysqli_set_charset($con, 'utf8mb4');
} else {
  $_SESSION['msg'] = "Database connection issue. Please try again later.";
}
...
{
  if (!isset($con) || !$con) {
    $_SESSION['msg'] = "Database not available. Password change disabled.";
  } else {
