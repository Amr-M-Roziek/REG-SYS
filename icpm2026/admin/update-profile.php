...
if(isset($_POST['Submit']))
{
  ...
  $stmt=mysqli_prepare($db_con,"update users set id=?, fname=?, lname=?, profession=?, category=?, email=?, organization=?, password=?, contactno=? where id=?");
  mysqli_stmt_bind_param($stmt,'issssssssi',$id,$fname,$lname,$profession,$category,$email,$organization,$enc,$contact,$uid);
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $stmt=mysqli_prepare($db_con,"select * from users where id=?"); $uid=intval($_GET['uid']); mysqli_stmt_bind_param($stmt,'i',$uid); mysqli_stmt_execute($stmt); $ret=mysqli_stmt_get_result($stmt);
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="regdate" value="<?php echo isset($row['created_at']) ? $row['created_at'] : (isset($row['posting_date']) ? $row['posting_date'] : '');?>" readonly >
                              </div>
                          </div>
