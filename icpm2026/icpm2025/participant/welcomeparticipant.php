    ...
    <div class="container" style="text-align: center;">
        <header class="jumbotron hero-spacer">
            ...
            <p>Welcome To ICPM 2025</p>
              ...
              <p><a  href="logout.php" class="btn btn-primary btn-large"> Logout </a>  <a  href="https://reg-sys.com/icpm2025/participant/participantfill.php" class="btn btn-primary btn-large"> Back Home </a>
            </p>
        </header>
