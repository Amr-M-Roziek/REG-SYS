<?php
session_start();
require_once( 'dbconnectionworkshop.php' );
...
<body>
  <div class="main">
    <h2>Transferring Classical HPLC and UHPLC Methods <br>
      into Green, Blue, and White Sustainable Analytical Methods<br><br>
    </h2  >
    <h3> Presented by:<br> Prof. Dr. Sami Eldeeb  <br>
      Professor of: Pharmaceutical Instrumental Analysis<br><br> 500 Euro </h3>
      <div class="sap_tabs">
                    ...
                    <div class="facts">
                      <div class="register">
                        <form name="registration" method="post" action="" enctype="multipart/form-data">
                          <p> ICPM 2026 Registration and Login System</p>
							<h2>Transferring Classical HPLC and UHPLC Methods <br>
      into Green, Blue, and White Sustainable Analytical Methods<br><br>
    </h2  >
    <h3> Presented by:<br> Prof. Dr. Sami Eldeeb  <br>
      Professor of: Pharmaceutical Instrumental Analysis</h3>
                          ...
                          <select type="text" class="text" name=" category" value="" required>
                            <option selected value="Workshop">Workshop DR.Sami</option>
                          </select>
                          <p>Organization </p>
                          ...
                          <input type="text" class="text" value="Prof. Dr. Sami Eldeeb" name="workshop name" disabled="disabled" required>
                          <hr/>
                          <!--<p>Paypal reference Number / payment confirmation</p>
                          <p>Please fill this field with paypal ref or confirmation number</p>
                          <input type="text" value="" name="paypalref"   >-->
                        </div>
