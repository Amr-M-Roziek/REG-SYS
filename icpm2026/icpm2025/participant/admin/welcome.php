...
<html lang="en">
  ...
  <h6> <img src=https://api.qrserver.com/v1/create-qr-code/?size=58x58&data=<?php echo $row['id'];?> title="Your reference Number is <?php echo $_SESSION['id'];?>" />Ref No: <?php echo $row['id'];?></h6>
