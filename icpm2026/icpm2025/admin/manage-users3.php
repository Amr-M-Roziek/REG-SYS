...
{
$usid=$_POST['usid'];
$ret= mysqli_query($con,"SELECT * FROM users WHERE id='$usid'");
...
{
echo "<script>alert('Not avalid number');</script>";
}
}
?><!DOCTYPE html>
<html lang="en">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                    ...
                    <form name="search" action="" method="post">
                      <input type="text" class="text" name="usid" value="" placeholder="Enter ID" required  >
                      <a href="#" class=" icon email"></a>    

                          <div class="submit three">
                            <input type="submit" name="send" onClick="myFunction()" value="search" >
                            <a href="welcome.php?usid=<?php echo $num['usid'];?>">
                            <button class="btn btn-primary btn-xs"><i class="fa fa-print"></i></button></a>
                          </div>
                        </form> -->
                    <!-- <form name="search" action="" method="post">
                    <p>Search users </p>
                      <input type="text" name="search" value="<?php echo $one; ?>">
                      <a href="welcome.php?uid=<?php echo $row['inputOne'];?>">
                          <i class="fa fa-users"></i>
                          <span>Search users Users</span>
                      </a>
</form> -->
                  </li>
              </ul>
                      ...
                      <div class="content-panel">
                          <div style="padding: 10px; float: right;">
                              <form method="GET" class="form-inline">
                                  ...
                                  <select name="limit" class="form-control" style="width: auto; display: inline-block;" onchange="this.form.submit()">
