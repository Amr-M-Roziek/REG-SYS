...
<html lang="en">
  ...
  <section id="container" >
    ...
    <h6> <img src="https://chart.googleapis.com/chart?chs=58x58&cht=qr&chl=<?php echo $row['id'];?>" title="Your reference Number is <?php echo $_SESSION['id'];?>" />Ref No: <?php echo $row['id'];?></h6>
