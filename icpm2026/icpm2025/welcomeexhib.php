    ...
    <div class="container" style="text-align: center;">
        <header class="jumbotron hero-spacer">
          ...
          <H2> <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?php echo $_SESSION['id'];?>" title="Your reference Number is <?php echo $_SESSION['id'];?>" /></H2>
            <H3>Reg No: <?php echo $_SESSION['id'];?></H3><br>
              <H2 style="text-transform:uppercase"><?php echo $_SESSION['scategory'];?></H2>
            <div>
            <p>Welcome To ICPM 2025</p>
            </div>
              <p><a  href="logout.php" class="btn btn-primary btn-large"> Logout </a>  <a  href="https://reg-sys.com/icpm2025/exhibitorfill.php" class="btn btn-primary btn-large"> Back Home </a>
            </p>
        </header>
