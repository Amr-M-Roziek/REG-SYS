...
if($row>0)
{
	print "<script>alert('Email id already exist with another account. Please try with other email id');</script>";
} else{
					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<p>Nationality </p>
								<input type="text" class="text" value="" name="nationality" >
								<p>Email Address - (Can't register twice with same email)</p>
								<input type="text" class="text" value="" name="email"  >
								<p>Profession </p>
								<input type="text" class="text" value="" name="profession"  >
								<p>Category</p>
								<input type="text" class="text" value="" name="category"  required>
                <p>Organization </p>
                <input type="text" class="text" value="" name="organization" required>
									<p><span style="color: black">Password ( Write your own password example: 123)</span></p>
