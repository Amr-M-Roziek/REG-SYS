...
if($msg)
{
	$stmt3= mysqli_prepare($con,"SELECT id FROM users WHERE email=?");
	...
	if($u){
		...
		$subject = "ICPM Registration Confirmation - Ref #".$u['id'];
...
Registration Number: ' . htmlspecialchars($u['id'], ENT_QUOTES, 'UTF-8') . '</p>
<p><img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=' . htmlspecialchars($u['id'], ENT_QUOTES, 'UTF-8') . '" alt="QR ' . htmlspecialchars($u['id'], ENT_QUOTES, 'UTF-8') . '"></p>
