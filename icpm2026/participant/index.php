...
if ( isset( $_POST[ 'signup' ] ) ) {
  ...
  if ( $row > 0 ) {
    ...
    if ( $msg ) {
        ...
        $stmt_id = mysqli_prepare($con, "SELECT id FROM users WHERE email=?");
        mysqli_stmt_bind_param($stmt_id, 's', $email);
        mysqli_stmt_execute($stmt_id);
        mysqli_stmt_bind_result($stmt_id, $uid);
        ...
        <p style="text-align:center">You have been registered successfully.</p>
        <p style="text-align:center">Please save your registration reference number.</p>
        <p style="text-align:center"><strong>Credentials</strong><br>
            ...
            <li class="resp-tab-item" aria-controls="tab_item-0" role="tab">
              ...
              <li class="resp-tab-item" aria-controls="tab_item-1" role="tab">
                ...
                <div class="resp-tabs-container">
                      ...
                      <div class="register">
                        <form name="registration" method="post" action="" enctype="multipart/form-data">
                          ...
                          <select type="text" class="text" name=" category" value="" required>
                            <option selected value="Participant">Participant CME</option>
                          </select>
                          <p>Organization </p>
                  ...
                  -->
                  <div id="dvPaymentType" style="display: none">
                    <p>My Company Paid for Me (Company / organization Name)</p>
                    <input type="text" name="companyref" id="companyref" />
                  </div>
                  <div id="dvPaymentPaypal" style="display: none">
                    <p>* Plaese Make Payment 100$<br>
                      ...
                      * Fill with Registered Company Name into Requested Field</p>
                      ...
                      <script src="https://www.paypal.com/sdk/js?client-id=AcFaEDQrIEflQi69flYQrw7QSirRAyXM8VeC0wBSO74PUEhzQCxFSWHFdKAZbLQZbze-17Li-r6yQyk2&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
                      <script>
                        ...
                        paypal.Buttons({
                          ...
                          createOrder: function(data, actions) {
                            return actions.order.create({
                              purchase_units: [{"description":"CME Participation Fees 100$","amount":{"currency_code":"USD","value":1}}]
                            });
                          },
