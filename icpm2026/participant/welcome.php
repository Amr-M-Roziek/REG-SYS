...
if (strlen($_SESSION['id']==0)) {
  header('location:logout.php');
    ...
    $uid = isset($_SESSION['id']) ? (string)$_SESSION['id'] : '';
    $secret_salt = 'ICPM2026_Secure_Salt';
    $hash = md5($uid . $secret_salt);
    $protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https://' : 'http://';
    $host = !empty($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'reg-sys.com';
    $certificateLink = $protocol . $host . "/icpm2026/download-certificate.php?id=" . urlencode($uid) . "&hash=" . urlencode($hash);
?><!DOCTYPE html>
<html lang="en">
    ...
    <div class="container" style="text-align: center;">
        <header class="jumbotron hero-spacer">
            ...
            <p>Welcome To ICPM 2026</p>
              ...
              <a id="btn-download-cert" class="btn btn-success btn-large" href="<?php echo htmlspecialchars($certificateLink); ?>"><i class="glyphicon glyphicon-download-alt"></i> Download Certificate</a>
            </p>
        </header>
