...
if(isset($_POST['login']))
{
  ...
  // Check access scope to prevent cross-system login
$stmt=mysqli_prepare($con,"SELECT * FROM admin WHERE username=? and password=? AND (access_scope='scientific' OR access_scope='both')");
		      ...
		      <form class="form-login" action="" method="post">
		        <h2 class="form-login-heading">sign in now</h2>
                  <p style="color:#F00; padding-top:20px;" align="center">
                    <?php if(isset($_SESSION['action1'])) { echo $_SESSION['action1']; $_SESSION['action1']=""; } ?></p>
