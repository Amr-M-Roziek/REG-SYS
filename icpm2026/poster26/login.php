...
if ( false )
{
  ...
  if ( $row > 0 )
  {
    ...
    $subject = "ICPM Poster Registration Confirmation";
    $footerImg = "https://regsys.cloud/icpm2026/images/icpm-logo.png";
    $message = '<div style="font-family:Arial,Helvetica,sans-serif;color:#111;line-height:1.6">
<p>Hello ' . htmlspecialchars($fname) . ',</p>
<p>Your registration for the ICPM Poster Competition has been received and confirmed.</p>
<p><strong>Login to your account:</strong><br>
<a href="https://regsys.cloud/icpm2026/poster26/login.php" target="_blank" rel="noopener">https://regsys.cloud/icpm2026/poster26/login.php</a></p>
...
- Poster must be in its place before the opening ceremony.<br>
...
<img src="' . $footerImg . '" alt="ICPM" width="200" height="78" style="display:inline-block">
    ...
    $headers = "From: ICPM@regsys.cloud\r\nMIME-Version: 1.0\r\nContent-Type: text/html; charset=utf-8\r\n";
