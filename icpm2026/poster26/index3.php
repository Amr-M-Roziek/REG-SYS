...
<a href="https://regsys.cloud/icpm2026/poster26/index.php" target="_blank" rel="noopener">https://regsys.cloud/icpm2026/poster26/index.php</a></p>
...
<img src="' . $footerImg . '" alt="ICPM" width="200" height="78" style="display:inline-block">
    ...
    $stmt = mysqli_prepare( $con, "insert into users(fname,nationality,coauth1name,coauth1nationality,coauth2name,coauth2nationality,coauth3name,coauth3nationality,coauth4name,coauth4nationality,coauth5name,coauth5nationality,email,profession,organization,category,password,contactno,userip,companyref,paypalref) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)" );
    mysqli_stmt_bind_param($stmt,'ssssssssssssssssssss',$fname,$nationality,$coauth1name,$coauth1nationality,$coauth2name,$coauth2nationality,$coauth3name,$coauth3nationality,$coauth4name,$coauth4nationality,$coauth5name,$coauth5nationality,$email,$profession,$organization,$category,$enc_password,$contact,$userip,$companyref,$paypalref);
