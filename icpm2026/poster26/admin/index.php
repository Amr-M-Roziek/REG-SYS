...
if(isset($_POST['login']))
{
  ...
  $stmt=mysqli_prepare($con,"SELECT * FROM admin WHERE username=? and password=? AND (access_scope='poster' OR access_scope='both')");
  ...
  if($num>0)
  {
    ...
    // Ensure CSRF token is present after login
